      ...
      switch (request.purchaseType) {
        case 'Cash':
            ...
            $('div[id="paymentDetails"]').append($('<ul>', {'class':"list-group"}).append($('<li>', {'class':'list-group-item', 'id':'purchase-type-li', 'text':"Purchase Type:Cash", 'data-type':request.purchaseType})));
             //Add default value to Total Payment input
            $("#total-payment-input").val(parseInt(offerJSON.offer.totalPayment));
            //Display the total payment input
          ...
          case 'Finance':
            ...
            //Add default value to Monthly Payment input
            $("#monthly-payment-input").val(parseInt(offerJSON.offer.monthlyPayment));
            //Display the monthly payment input
